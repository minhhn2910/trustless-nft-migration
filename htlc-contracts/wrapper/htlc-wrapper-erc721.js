...
class HtlcErc721Wrapper extends BaseWrapper {
   ...
   */
  newContract(receiverAddress, hashlock, timelock, tokenContract, tokenId, forwardlink, sender) {
    return this.getContractInstance().then((instance) => {
      return instance.newContract(receiverAddress, hashlock, timelock, tokenContract, tokenId, forwardlink, {
        from: sender,
      })
    })
  }
